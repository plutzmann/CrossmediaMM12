			...
			switch ( $value['type'] ) {
				...
				case 'typography':
					...
					if(isset($typography_stored['face'])) {
						...
						global $tw_googlefonts, $tw_simplefonts;
                                                $faces = array_merge($tw_simplefonts, $tw_googlefonts);
				...
				case 'backup':
					...
					$output .= '<p><strong>'. __('Last Backup : ','themewaves').'<span class="backup-log">'.$log.'</span></strong></p></div>'."\n";
				...
				case 'select_google_font':
					...
					$output .= '<select class="select of-input google_font_select" name="'.$value['id'].'" id="'. $value['id'] .'">';
                                        $faces = array_merge($tw_simplefonts, $value['options']);
					foreach ($faces as $select_key => $option) {
